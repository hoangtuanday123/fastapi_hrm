...
candidate=APIRouter()
@candidate.get('/candidate/{image_path}/{fullname}',tags=['candidate'], response_class=HTMLResponse)
...
@candidate.post('/candidate/{image_path}/{fullname}',tags=['candidate'], response_class=HTMLResponse)
